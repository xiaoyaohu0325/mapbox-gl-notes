...
import { createVertexArrayType } from '../vertex_array_type';
import { createElementArrayType } from '../element_array_type';
import { StructArray, ViewType } from '../../util/struct_array';
...
export class FillBucket extends Bucket {
  constructor(options) {
